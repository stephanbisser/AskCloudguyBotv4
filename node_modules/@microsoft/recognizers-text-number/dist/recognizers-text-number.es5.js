...
// 1 234 567
LongFormatType.integerNumNoBreakSpace = new LongFormatType(' ', '\0');
// 1'234'567
...
(function (ChineseNumeric) {
    ...
    ChineseNumeric.SimpleIntegerPercentageRegex = `(?<=(\\s|^))${ChineseNumeric.NegativeNumberTermsRegexNum}?${ChineseNumeric.ZeroToNineFullHalfRegex}+([\\.．]${ChineseNumeric.ZeroToNineFullHalfRegex}+)?(\\s*)[％%]`;
...
var extractors_2$5 = extractors$12.ChineseNumberExtractorMode;
...
var recognizersTextNumber_69 = recognizersTextNumber.ChineseNumberExtractorMode;
